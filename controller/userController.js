...
const verifyEmailAddress = async (req, res) => {
  ...
  if (isAdded) {
    ...
    const body = {
      ...
      <p>Verify your email address to complete the signup and login into your <strong>SardarBaba</strong> account.</p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@sardarbaba.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>SardarBaba Team</strong>
             `,
    };
...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>SardarBaba</strong> account </p>
